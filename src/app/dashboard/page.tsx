...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 animate-fade-in-up relative">
      {/* Decorative background elements */}
      <div className="absolute top-0 right-0 w-1/2 h-full bg-green-900/5 dark:bg-green-800/10 z-0 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <svg className="w-full h-full" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
            <path d="M46,230 C146,307 287,261 341,171 C395,81 343,28 284,58 C225,88 178,171 102,187 C26,203 -54,153 46,230 Z" fill="none" stroke="currentColor" strokeWidth="0.5" className="text-green-700 dark:text-green-500" />
            <path d="M128,144 C100,187 122,250 178,277 C234,304 297,252 332,181 C367,110 341,19 255,42 C169,65 156,101 128,144 Z" fill="none" stroke="currentColor" strokeWidth="0.5" className="text-green-700 dark:text-green-500" />
            <path d="M78,274 C134,177 228,207 287,139 C346,71 340,4 266,33 C192,62 156,165 78,274 Z" fill="none" stroke="currentColor" strokeWidth="0.5" className="text-green-700 dark:text-green-500" />
          </svg>
        </div>
      </div>
      ...
      <div className="relative z-10 p-8">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="w-10 h-10 rounded-full bg-light-blue flex items-center justify-center text-white">
              <span>JD</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            {isLoading ? (
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Weather</h2>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Current conditions</p>
                  </div>
                  <div className="text-3xl font-bold text-gray-800 dark:text-white">{currentWeather.temperature}°C</div>
                </div>
                
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Humidity</div>
                    <div className="text-lg font-semibold text-gray-800 dark:text-white">{currentWeather.humidity}%</div>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Wind</div>
                    <div className="text-lg font-semibold text-gray-800 dark:text-white">{currentWeather.wind.speed} km/h</div>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Precipitation</div>
                    <div className="text-lg font-semibold text-gray-800 dark:text-white">{currentWeather.chanceOfRain}%</div>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Pressure</div>
                    <div className="text-lg font-semibold text-gray-800 dark:text-white">{currentWeather.pressure} hPa</div>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="col-span-2 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
            {isLoading ? (
              <div className="p-6">
                <div className="animate-pulse">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-lg font-semibold text-gray-800 dark:text-white">7-Day Forecast</h2>
                  <div className="flex space-x-1">
                    <button className="px-3 py-1 text-sm bg-light-blue text-white rounded-md">Weekly</button>
                    <button className="px-3 py-1 text-sm bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-md">Monthly</button>
                  </div>
                </div>
                ...
                <div className="space-y-6 relative">
                  ...
                  {dailyForecast.slice(0, 5).map((day, index) => (
                    <div key={index} className="flex items-center relative">
                      <div className="w-14 text-sm text-gray-500 dark:text-gray-400 mr-4">{day.day}</div>
                      ...
                      <div className="ml-4 flex-grow">
                        <div className="text-sm font-medium text-gray-800 dark:text-white">{day.condition}</div>
                      ...
                      <div className="ml-4 w-16 text-right">
                        <span className="text-sm font-medium text-gray-800 dark:text-white">{day.high}°</span>
                        <span className="text-sm text-gray-500 dark:text-gray-400 ml-1">{day.low}°</span>
                      </div>
                    </div>
                  ))}
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-white mb-6">Hourly Temperature</h2>
          ...
          <div className="col-span-2 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-white mb-6">Weather Insights</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {weatherInsights.map((insight, index) => (
                  <div key={index} className="flex">
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-800 dark:text-white">{insight.type}</h3>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="p-4 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Weather Map</h2>
