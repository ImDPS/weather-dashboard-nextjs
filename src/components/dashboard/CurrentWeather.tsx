      ...
      {isLoading ? (
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-lg font-semibold text-dark-blue dark:text-white">Weather in {city.name}</h2>
              <p className="text-dark-gray dark:text-gray-400 text-sm">{city.currentWeather.condition}</p>
            </div>
            <div className="text-3xl font-bold text-dark-blue dark:text-white">{city.currentWeather.temperature}°C</div>
          </div>
